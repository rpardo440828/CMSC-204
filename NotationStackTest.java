...
public class NotationStackTest {
	...
	Double x = 4.0, y = 5.0, z = 6.0, g = 10.0, h = 11.0, i = 12.0;
	...
	public void testPushStudent()
	{
		try 
		{
			...
			assertEquals(true, doubleS.push(g));
			assertEquals(4, doubleS.size());
			assertEquals(true, doubleS.push(h));
	...
	public void testToStringStudent() throws StackOverflowException
	{
		...
		doubleS.push(g);
		assertEquals("4.05.06.010.0", doubleS.toString());
		doubleS.push(h);
		assertEquals("4.05.06.010.011.0", doubleS.toString());
	}
